...
public class FormFornecedor extends javax.swing.JInternalFrame {
    ...
    private void jBtnNovoForActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ativarCamposFor();
    ...
    private void jBtnEditarForActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ativarCamposFor();
        editFor = true;
    ...
    private void jBtnExcluirForActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void jBtnCancelarForActionPerformed(java.awt.event.ActionEvent evt) {                                                
        desativarCamposFor();
    ...
    private void jBtnSalvarForActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    // Tecla pressionada
    private void jTfCodForKeyReleased(java.awt.event.KeyEvent evt) {                                      
        jBtnSalvarFor.setEnabled(isAnyFilledFor());
    }                                     

    private void jTfContatoForKeyReleased(java.awt.event.KeyEvent evt) {                                          
        jBtnSalvarFor.setEnabled(isAnyFilledFor());
    }                                         

    private void jTfEmailForKeyReleased(java.awt.event.KeyEvent evt) {                                        
        jBtnSalvarFor.setEnabled(isAnyFilledFor());
    }                                       

    private void jTfFoneForKeyReleased(java.awt.event.KeyEvent evt) {                                       
        jBtnSalvarFor.setEnabled(isAnyFilledFor());
    }                                      

    private void jTfNomeForKeyReleased(java.awt.event.KeyEvent evt) {                                       
        jBtnSalvarFor.setEnabled(isAnyFilledFor());
    }                                      

    
    // Mouse
    private void jTblForMouseClicked(java.awt.event.MouseEvent evt) {                                     
