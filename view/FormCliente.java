...
public class FormCliente extends javax.swing.JInternalFrame {
    ...
    //Ações dos Botões
    private void jBtnNovoCliActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ativarCamposCli();
    ...
    private void jBtnSalvarCliActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void jBtnCancelarCliActionPerformed(java.awt.event.ActionEvent evt) {                                                
        desativarCamposCli();
    ...
    private void jBtnExcluirCliActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void jBtnEditarCliActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ativarCamposCli();
        editCli = true;
    ...
    // Tecla pressionada
    private void jTfCodCliKeyReleased(java.awt.event.KeyEvent evt) {                                      
        jBtnSalvarCli.setEnabled(isAnyFilledCli());
    }                                     

    private void jTfNomeCliKeyReleased(java.awt.event.KeyEvent evt) {                                       
        jBtnSalvarCli.setEnabled(isAnyFilledCli());
    }                                      

    private void jTfFoneCliKeyReleased(java.awt.event.KeyEvent evt) {                                       
        jBtnSalvarCli.setEnabled(isAnyFilledCli());
    }                                      

    private void jTfEmailCliKeyReleased(java.awt.event.KeyEvent evt) {                                        
        jBtnSalvarCli.setEnabled(isAnyFilledCli());
    }                                       

    private void jTfEnderecoCliKeyReleased(java.awt.event.KeyEvent evt) {                                           
        jBtnSalvarCli.setEnabled(isAnyFilledCli());
    }                                          

    //Clique do Mouse
    private void jTblCliMouseClicked(java.awt.event.MouseEvent evt) {                                     
